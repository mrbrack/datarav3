  ...
  return (
    <>
      ...
      <Section type="standard">
        ...
        <p>
          At datarav3, accessible from www.datarav3.art, one of our main
          priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by datarav3 and how we use it.
        </p>
        ...
        <p>
          ...
          shared and/or collect in datarav3. This policy is not applicable to
        ...
        <p>
          datarav3 follows a standard procedure of using log files. These files
        ...
        <p>
          Like any other website, datarav3 uses &ldquo;cookies&ldquo;. These
        ...
        <p>
          ...
          advertising partners of datarav3.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on datarav3, which are sent
        ...
        <p>
          Note that datarav3 has no access to or control over these cookies that
        ...
        <p>
          datarav3&apos;s Privacy Policy does not apply to other advertisers or
        ...
        <p>
          datarav3 does not knowingly collect any Personal Identifiable
